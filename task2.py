...
dt_fix = lambda x: pd.to_datetime(x.fillna('2024-01-01'), errors='coerce', format='mixed').dt.normalize().pipe(lambda d: d.where(d.dt.year.between(2000, 2025))) + pd.to_timedelta(np.random.randint(32400, 61201, len(x)), unit='s')
